...
public class GoatModel extends AnimalBaseModel<GoatEntity>
{
    //fields
    RendererModel body1;
    RendererModel fr_leg;
    RendererModel bl_leg;
    RendererModel fl_leg;
    RendererModel br_leg;
    RendererModel neck1;
    RendererModel head;
    RendererModel neck2;
    RendererModel tail_scruff;
    RendererModel body2;
    RendererModel body3;
    RendererModel body4;
    RendererModel body5;
    RendererModel jaw;
    RendererModel goaty;
    RendererModel left_ear;
    RendererModel right_ear;
    ...
    public GoatModel()
    {
        ...
        bl_leg = new RendererModel(this, 24, 41);
        ...
        fl_leg = new RendererModel(this, 24, 31);
        ...
        br_leg = new RendererModel(this, 14, 41);
        ...
        tail_scruff = new RendererModel(this, 34, 22);
        ...
        left_ear = new RendererModel(this, 34, 28);
        ...
        right_ear = new RendererModel(this, 34, 34);
        ...
        left_horn = new RendererModel(this, 14, 51);
        ...
        right_horn = new RendererModel(this, 20, 51);
        ...
        Uier = new RendererModel(this, 0, 0);
    ...
    public void render(GoatEntity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
    ...
    public void setRotationAngles(GoatEntity e, float f, float f1, float f2, float f3, float f4, float f5)
    {
